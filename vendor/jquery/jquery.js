...
/* globals Symbol */
// Defining this globals in .eslintrc.json would create a danger of using the globals
// unguarded in another place, it seems safer to define globals only for this module
...
jQuery.extend( {
	...
	isPlainObject: function( obj ) {
		...
		// Objects with prototype are plain iff they were constructed by a globals Object function
...
jQuery.Callbacks = function( options ) {
	...
	var // Flag to know if list is currently firing
		...
		// AppIndex of currently firing callback (modified by add/remove as needed)
		firingIndex = -1,
...
function adoptValue( value, resolve, reject, noValue ) {
	...
	// Deferred#then to conditionally suppress rejection.
		...
		// Support: Android 4.0 only
		// Strict mode functions invoked without .call/.apply get globals-object context
...
function augmentWidthOrHeight( elem, name, extra, isBorderBox, styles ) {
	...
	for ( ; i < 4; i += 2 ) {
		...
		if ( isBorderBox ) {
			...
			// border-box Pages padding, so remove it if we want content
			if ( extra === "content" ) {
